...
import {MetaNumber} from "./MetaSemantics.js";
import SVG from "../Svg.js";
import {Variable} from "../constraints.js";
...
export default class NumberToken extends Token {
  constructor(arg = 0, source) {
    ...
    this.editValue = "";
    this.elm = SVG.add("g", SVG.metaElm, {class: "number-token"});
    this.boxElm = SVG.add("rect", this.elm, {
      class: "token-box",
      height: this.height
    });
    this.wholeElm = SVG.add("text", this.elm, {
      class: "token-text"
    });
    this.fracElm = SVG.add("text", this.elm, {
...
export const aNumberToken = (gameObj) => gameObj instanceof NumberToken ? gameObj : null;
