import Token, {aToken} from "./Token.js";
import SVG from "../Svg.js";
import Vec from "../../lib/vec.js";
import NumberToken, {aNumberToken} from "./NumberToken.js";
import OpToken from "./OpToken.js";
import EmptyToken, {anEmptyToken} from "./EmptyToken.js";
import WritingCell, {aWritingCell} from "./WritingCell.js";
...
export default class Formula extends Token {
  ...
  updateWritingCells() {
    ...
    for (const cell of cells) {
      offsetInsideToken += 1;
      const tokenSize = token instanceof NumberToken ? token.editValue.length : 1;
  ...
  render(dt, t) {
    ...
    for (const token of this.findAll({what: aToken})) {
      ...
      nextTokenPosition = Vec.add(nextTokenPosition, Vec(token.width + PADDING, 0));
    }
...
export const aFormula = (gameObj) => gameObj instanceof Formula ? gameObj : null;
